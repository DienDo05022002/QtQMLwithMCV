...
#include <memory>
#include "../../../QtQML-Lib/AppQML/itemmodel.h"
...
QT_MOC_LITERAL(4, 24, 10), // "removeItem"
QT_MOC_LITERAL(5, 35, 5), // "index"
QT_MOC_LITERAL(6, 41, 10) // "updateItem"

    },
    "ItemModel\0addItem\0\0text\0removeItem\0"
    "index\0updateItem"
};
...
void ItemModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ItemModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addItem((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->removeItem((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->updateItem((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}

QT_INIT_METAOBJECT const QMetaObject ItemModel::staticMetaObject = { {
    &QAbstractListModel::staticMetaObject,
    qt_meta_stringdata_ItemModel.data,
    qt_meta_data_ItemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
